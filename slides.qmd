...
- Data scientist @ Jumping Rivers
  ...
  - We offer an introductory Shiny course
    - jumpingrivers.com/training
...
- Mainly used by data professionals to build dashboards
  - Usage becoming more widespread and more varied
...
- Visual hierarchy is the order in which the user process information by importance
  - With the correct use of hierarchy, the mind can group and prioritize elements to give them a specific order
  - If not placed through a correct hierarchy, generate disorder and greater effort in navigation
...
- As you're learning about a bunch of cool packages and features that you can add to your Shiny app, it's easy to overdo it and end up adding features *just because*
- The more you add, the more difficult your app will be to interact with for the user (**increased cognitive load**)
  - It may also slow down your app significantly!
...
1. Add min. age input into "+ More filters"
...
- I wouldn't worry about meeting all these principles from the get go
